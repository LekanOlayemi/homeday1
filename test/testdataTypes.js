(function(){
  'use strict';
  var dataTypes = require("../app/librarydataTypes.js");

describe("Data types tests ", function() {
  describe("Case for some falsy values", function() {

    it("should return 'no value ' for null", function() {
      expect(dataTypes(null)).toBe('no value ');
    });

    it("should return 'no value ' for undefined", function() {
      expect(dataTypes(undefined)).toBe('no value ');
    });
  ...
  describe("Case for Strings", function() {
    ...
    it("should return '12' for tergiversate", function() {
    ...
    it("should return '3' for 555", function() {
